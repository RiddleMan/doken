...
mod tests {
  ...
  "data": {
    ...
    async fn it_reads_state_of_correct_client_id() {
        ...
        assert_eq!(actual_token_info.access_token, expected_token_info.access_token);
        assert_eq!(actual_token_info.refresh_token, expected_token_info.refresh_token);
